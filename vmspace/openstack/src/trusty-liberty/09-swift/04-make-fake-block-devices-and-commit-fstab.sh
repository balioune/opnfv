...
echo \* Writing $FSTAB ...
echo /srv/block/d6          /srv/node/d6 xfs noatime,nodiratime,nobarrier,logbufs=8 0 2 | sudo tee -a $FSTAB
echo /srv/block/d7          /srv/node/d7 xfs noatime,nodiratime,nobarrier,logbufs=8 0 2 | sudo tee -a $FSTAB
echo /srv/block/d8          /srv/node/d8 xfs noatime,nodiratime,nobarrier,logbufs=8 0 2 | sudo tee -a $FSTAB
echo \* All Done !
