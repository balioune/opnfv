...
cp /vagrant/local2.conf $CONF_FILE
...
#sed '2 s/$/\n[filter:moon]\nuse = egg:keystone#moon_extension\n/' /tmp/_k1 > /tmp/_k2
...
pip install /vagrant/keystonemiddleware-2.3.1.dev2.tar.gz
...
auth_uri = http://192.168.22.10:35357/v3
authz_login = admin
